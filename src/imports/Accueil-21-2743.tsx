...
function Frame14() {
  return (
    <div className="content-stretch flex flex-col gap-[14px] items-start relative shrink-0 w-full">
      <div className="flex flex-col font-['Jost',_sans-serif] font-normal justify-center leading-[100%] relative shrink-0 text-[18px] text-white w-full" style={{letterSpacing: '0%', verticalAlign: 'middle'}}>
...
function CollectionEtEvenement() {
  return (
    <div className="bg-[#f2e8d5] h-[1055px] overflow-clip relative shrink-0 w-full" data-name="Collection et Evenement">
      <Container31 />
      <Frame1321316016 />
      <Link2 />
    </div>
