import svgPaths from "./svg-oq3yv558k7";
...
export default function CollectionEtEvenement() {
  return (
    <div className="bg-[#f2e8d5] relative size-full" data-name="Collection et Evenement">
      <Container18 />
      <Frame1321316016 />
      <Link />
    </div>
