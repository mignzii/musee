import svgPaths from "./svg-cfyiten3rq";
import CollectionEtEvenementNew from "./CollectionEtEvenement";
...
import imgImage2 from "figma:asset/9cc6a0ff2579afcef533f970476404a89e9c297b.png";
...
function Margin() {
  return (
    <div className="box-border content-stretch flex flex-col h-[81px] items-start max-w-[1085.81px] pl-0 pr-[64px] py-0 relative shrink-0" data-name="Margin">
...
function Container7() {
  return (
    <div className="content-stretch flex h-full items-start justify-center min-h-px relative shrink-0 w-[268.36px]" data-name="Container">
      <Container6 />
    </div>
  );
}
...
function HeroSection() {
  return (
    <div className="h-[789px] overflow-clip relative shrink-0 w-full" data-name="Hero section">
      <Content />
    </div>
  );
}
...
function Frame1321316014() {
  return (
    <div className="absolute content-stretch flex gap-[79px] items-center left-[calc(50%+0.578px)] top-[79px] translate-x-[-50%]">
      <Group3 />
      <Frame1321316013 />
    </div>
  );
...
function APropos() {
  return (
    <div className="bg-[#242424] h-[821px] overflow-clip relative shrink-0 w-full" data-name="A propos">
      <Frame1321316014 />
    </div>
  );
}
...
function Container31() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[30px] right-[30px] top-[calc(50%+68.61px)] translate-y-[-50%]" data-name="Container">
      <Section1 />
    </div>
  );
}
...
function CollectionEtEvenement() {
  return <CollectionEtEvenementNew />;
}
...
function VisiteVirtuelle() {
  return (
    <div className="bg-[#242424] h-[802px] overflow-clip relative shrink-0 w-full" data-name="Visite virtuelle">
      <Frame />
      <Frame1321316012 />
    </div>
  );
...
function Container40() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[7.8px] items-start min-w-[819.83px] mr-[-0.01px] pb-[8.52px] pt-0 px-0 relative shrink-0" data-name="Container">
      <Heading4Link />
      <Container39 />
    </div>
  );
...
function Container52() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[7.8px] items-start min-w-[819.83px] mr-[-0.01px] pb-[8.51px] pt-0 px-0 relative shrink-0" data-name="Container">
      <Heading4Link1 />
      <Container51 />
    </div>
  );
...
function Container68() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[27.2px] items-start left-[62px] right-[60px] top-[229.09px]" data-name="Container">
      <Container45 />
      <HorizontalBorder />
      <HorizontalBorder1 />
    </div>
...
function Icon14() {
  return <div className="h-[14px] w-[3.09px]" data-name="Icon" />;
}
...
function ArticleRecent() {
  return (
    <div className="bg-[#242424] h-[782px] overflow-clip relative shrink-0 w-full" data-name="Article récent">
      <Container105 />
    </div>
  );
}
    ...
    <div className="content-stretch flex gap-[27px] items-center relative shrink-0" data-name="socials">
      ...
      <div className="h-[16.151px] relative shrink-0 w-[15.565px]" data-name="Combined Shape">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 17">
          <path d={svgPaths.p3a18d900} fill="var(--fill-0, #101010)" id="Combined Shape" />
        </svg>
      </div>
    </div>
  );
...
export default function Frame1321316023() {
  return (
